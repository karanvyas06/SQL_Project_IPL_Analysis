...
CREATE TABLE IPL_BIDDER_POINTS (
  ...
  REMARKS varchar(200) DEFAULT NULL,
  CONSTRAINT ipl_bidder_points_ibpfk_1 FOREIGN KEY (bidder_id) REFERENCES IPL_BIDDER_DETAILS (bidder_id),
  CONSTRAINT ipl_tournmt_id_ibpfk_1 FOREIGN KEY (TOURNMT_ID) REFERENCES IPL_TOURNAMENT (TOURNMT_ID)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IPL_BIDDING_DETAILS (
  ...
  CONSTRAINT ipl_bidder_id_ibfk_1 FOREIGN KEY (bidder_id) REFERENCES IPL_BIDDER_DETAILS (bidder_id),
  CONSTRAINT ipl_schedule_id_isifk_1 FOREIGN KEY (schedule_id) REFERENCES IPL_MATCH_SCHEDULE (schedule_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IPL_MATCH (
  ...
  constraint ipl_match_team1_emt1fk foreign key (team_id1) references IPL_TEAM (team_id),
  constraint ipl_match_team1_emt2fk foreign key (team_id2) references IPL_TEAM (team_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IPL_MATCH_SCHEDULE (
  ...
  constraint ipl_match_id_imsfk foreign key (match_id) references IPL_MATCH (match_id),
  constraint ipl_tournmt_id_tisfk foreign key (tournmt_id) references IPL_TOURNAMENT (tournmt_id),
  constraint ipl_stadium_id_sifk foreign key (stadium_id) references IPL_STADIUM (stadium_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IPL_TEAM_PLAYERS (
  ...
  constraint ipl_team_id_itpfk foreign key (team_id) references IPL_TEAM (team_id),
  constraint ip_player_id_ipifk foreign key (player_id) references IPL_PLAYER (player_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE IPL_TEAM_STANDINGS (
  ...
  constraint ipl_team_id_itifk foreign key (team_id) references IPL_TEAM (team_id),
  constraint ipl_tournmt_id_itidfk foreign key (tournmt_id) references IPL_TOURNAMENT (tournmt_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
